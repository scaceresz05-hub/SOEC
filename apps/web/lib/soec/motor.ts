...
export const alternativa: Alternativa = { alternativaId: 'alt-repetir', oportunidadId: 'op1', cambia: ['politica_operacional'], constantes: ['segmento', 'hipotesis'], razon: 'repetir el experimento ganador', hipotesisId: 'hip1', riesgo: 'bajo', costoEstimado: 10, beneficioEsperado: 'mejor CTR', kpiAfectado: 'ctr', evidencia: ['eval1 respaldada'], condicionesExito: ['CTR sube'], condicionesAbandono: ['CTR baja'], planReversion: 'volver al plan anterior', alcance: 'LOCAL', naturaleza: 'SIMULADO' };
const oportunidad: Oportunidad = { oportunidadId: 'op1', tipo: 'repetir', fundamento: 'evidencia respaldada', evidencia: ['eval1'], contraevidencia: [], alcance: 'LOCAL', confianza: 'media', riesgo: 'bajo', costoEstimado: 10, impactoEsperado: 'mejor CTR', reversibilidad: 'reversible', restricciones: [], informacionFaltante: [], dependencias: [], naturaleza: 'SIMULADO' };
...
async function construir(): Promise<Soec> {
  ...
  await propuestas.proponer(c, 'prop1', { cicloId: 'ciclo1', versionesBase: vb, alternativaElegida: alternativa, alternativasDescartadas: [], artefactosAfectados: ['plan'], hipotesisId: 'hip1', kpis: ['ctr'], evidencia: ['eval1'], contraevidencia: [], impactoEsperado: 'mejor CTR', costoEstimado: 10, riesgos: [], rollbackLogico: 'volver al plan anterior', explicacion: 'El gancho directo superó la meta; propongo repetir antes de generalizar.', naturaleza: 'SIMULADO' }, A, O);
