...
9. **Cierre humano del ciclo estratégico** *(v1.7)*. El ciclo perpetuo de **comprensión y decisión estratégica** se cierra a través de la persona que decide: SOEC no fija la estrategia ni sustituye el juicio. La **ejecución de acciones operativas previamente autorizadas por una política humana vigente** (Const. 2.4 v1.7; #14 §6) puede cerrarse dentro del sistema —trazable, reversible donde sea posible, supervisada y revocable— sin cerrar por ello el lazo estratégico, que permanece humano.
