...
| 5 | M7 — Motor de Operación y Ejecución Gobernada (OrdenEjecucion 11 estados, validación autoritativa M6, scheduler, cola con lease, ejecutor gobernado idempotente + presupuesto M4-D, evidencia inmutable, reconciliación, contratos M8) | **Núcleo consolidado** (`verify` global 1134 verde) | 1 | 13 (`@soec/motor-operacion`); **1134 global** | 0 | discovery-first (mapa de 13 componentes; reuso de LecturaCreativa/sandbox M4/presupuesto M4-D); autoauditoría de cadena+recuperación aplicando lecciones I-2..I-5 desde el inicio (concurrencia de lease, idempotencia de efectos, replay frío, cross-tenant, inmutabilidad M8) | pendiente | 0 | 1 ciclo (núcleo) |
