...
| 2 | M4-D — andamiaje neutral + frontera | **Consolidado** (`verify` global 1023 verde, PG revalidado) | 7 | 152 (2 paquetes M4); **1023 global** | **1** (feedback metodológico) | **2** autoauditoría (presupuesto fail-open; gate de nivel diferido) + DRY/consolidación (fnv1a, errorAborto) + no-filtración por path completo | 0 externo | 0 | 1 ciclo |
