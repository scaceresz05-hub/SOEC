...
| 4 | M6 — Motor Creativo Estratégico (contexto-puente M5, gate AUTORITATIVO, abstención 1.ª clase, brief/pieza ampliados, PIPELINE dos fases, vigencia gate único + materialización, LecturaCreativa completa) | **Cerrado** (`verify` global 1095 verde) | 4 | 39 (motor-creativo 35 + estrategia-creativa 4); **1095 global** | **2 (necesarias, de método)**: I-2 cierre prematuro (pendientes eran LOCKED) → cerrado sin detención; I-3 componentes sin demostrar INTERACCIONES gobernadas → corregido | discovery-first; autoauditoría de interacciones (A–F): vigencia gate único, dos fases con aprobación, fallo parcial reparable, replay frío | 2 dictámenes de foco del usuario (cierre interno; correcciones focalizadas) | 2 (cierre interno; correcciones focalizadas) | 3 ciclos (núcleo → cierre → interacciones) |
