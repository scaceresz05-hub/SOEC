...
| 4 | M6 — Motor Creativo Estratégico (contexto-puente M5, gate AUTORITATIVO, dos fases con solicitud+aprobación, vigencia gate único + materialización, recuperación/concurrencia/replay-frío/inmutabilidad, LecturaCreativa completa) | **Cerrado** (`verify` global 1112 verde) | 5 | 52 (motor-creativo) + 6 (estrategia-creativa/contenido/event-store); **1112 global** | **3 (necesarias, de método)**: I-2 cierre prematuro; I-3 interacciones no demostradas; I-4 recuperación/atomicidad no demostrada en todas las fronteras | discovery-first; autoauditoría de interacciones y de RECUPERACIÓN (matriz de fallos parciales, concurrencia, replay frío, inmutabilidad runtime) | 3 dictámenes de foco del usuario | 3 | 4 ciclos (núcleo → cierre → interacciones → recuperación) |
