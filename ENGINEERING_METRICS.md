...
| 3 | M5 — Motor Estratégico Comercial (núcleo de evaluabilidad canónico + afirmación estratégica) | **Consolidado** (`verify` global 1052 verde) | 1 | 26 (`@soec/motor-estrategico`); **1052 global** | **0** | **2** autoauditoría (explicación honesta de retiro; rama muerta en empate de suficiencia) | 0 externo | 0 | 1 ciclo |
