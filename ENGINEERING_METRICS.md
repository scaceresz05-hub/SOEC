...
| 4 | M6 — Motor Creativo Estratégico (núcleo: contexto-puente M5 + obsolescencia, territorio, mensajes tipados, gate de validación AUTORITATIVO, abstención 1.ª clase, LecturaCreativa; ampliación aditiva de la EstrategiaCreativa M3) | **Consolidado (núcleo); pendientes aditivos declarados** (`verify` global 1081 verde) | 1 | 23 (motor-creativo 21 + estrategia-creativa 2); **1081 global** | **0** | discovery-first (8+ paquetes M3 mapeados antes de crear); autoauditoría de 16 escenarios adversariales | 0 externo | 0 | 1 ciclo |
